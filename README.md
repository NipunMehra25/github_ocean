...
github_ocean/
  ...
  README.md
  src/
    main.js          # app logic, rendering, mapping, audio
    style.css        # layout, responsive UI, glass styling
  assets/
    models/          # .glb fish/creature models
    shaders/         # GLSL shader sources
    fonts/           # custom typography assets
    icons/           # app + favicon icons
    media/           # overlay videos
    audio/
      fish/          # optional fish sound loops
  docs/
    FISH_MAPPING.md  # deep mapping reference
```
